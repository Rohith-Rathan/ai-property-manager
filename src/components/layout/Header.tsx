...
export default function Header({ 
  ...
  // Responsive variant - shows mobile on small screens, desktop on large screens
  if (variant === 'responsive') {
    return (
      <>
        {/* Mobile Header - Hidden on larger screens */}
        <div className="header-mobile-only bg-paper-paper-elevation-1 border-b border-overlays-white-inverse-10 border-solid h-20 relative shrink-0 w-full shadow-card-large" data-name="Header Mobile Responsive">
          <div className="bg-clip-padding border-0 border-transparent border-solid box-border content-stretch flex h-20 items-center relative w-full">
            {/* Logo Section */}
            <div className="border-r border-overlays-black-20 border-solid box-border content-stretch flex flex-col h-20 items-center justify-center p-4 relative shrink-0 w-16" data-name="Logo Container">
              <button 
            ...
            <div className="basis-0 box-border content-stretch flex grow h-full items-center justify-end min-h-px min-w-px px-1 py-2 relative shrink-0" data-name="Actions Container">
              <div className="content-stretch flex gap-2 items-center relative shrink-0" data-name="Actions">
                ...
                {/* Notifications */}
                <div className="content-stretch flex items-center justify-center relative rounded-lg shrink-0 w-8 h-8" data-name="Notifications">
                  <div className="relative">
                    <ThemeIcon src={notificationIcon} alt="Notifications" size="sm" variant="default" />
                    {notificationCount > 0 && (
                      <div className="absolute -top-1 -right-1 bg-error-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center">
                        {notificationCount}
                      </div>
                    )}
                  </div>
                ...
                {/* Settings */}
                <div className="content-stretch flex items-center justify-center relative rounded-lg shrink-0 w-8 h-8" data-name="Settings">
                  <ThemeIcon src={settingsIcon} alt="Settings" size="sm" variant="default" />
                </div>
        ...
        <div className="header-desktop-only bg-paper-paper-elevation-1 border-b border-overlays-white-inverse-10 border-solid h-20 relative shrink-0 w-full shadow-card-large" data-name="Header Desktop Responsive">
          <div className="bg-clip-padding border-0 border-transparent border-solid box-border content-stretch flex h-20 items-center relative w-full">
            {/* Logo Section */}
            ...
            {/* Search Section */}
            <div className="basis-0 box-border content-stretch flex grow h-full items-center justify-start min-h-px min-w-px px-4 py-2 relative shrink-0" data-name="Search Container">
              <SearchInput
            ...
            {/* Right Side Actions */}
            <div className="box-border content-stretch flex h-full items-center justify-end px-4 py-2 relative shrink-0" data-name="Actions Container">
              <div className="content-stretch flex gap-2 items-center relative shrink-0" data-name="Actions">
                {/* Notifications */}
                <div className="content-stretch flex items-center justify-center relative rounded-lg shrink-0 w-8 h-8" data-name="Notifications">
                  <div className="relative">

...
const editIcon = getAssetPath('edit-property-icon'); // Fixed: proper edit icon
    ...
    <div className={getCardClasses()} data-name="Property Card">
      ...
      <div className="flex flex-col gap-4 items-center overflow-clip relative rounded-tl-xxl rounded-tr-xxl shrink-0 w-full" data-name="Card">
        <div className="h-48 relative shrink-0 w-full" data-name="ImageWithFallback">
          ...
          {property.badge && (
            <div className={`absolute ${getBadgeColorClass(property.badgeColor)} box-border flex gap-1 h-6 items-center justify-center overflow-clip px-2 py-0.5 right-4 rounded-lg top-6`} data-name="Badge">
      ...
      {/* Content Section */}
      <div className="box-border flex flex-col gap-4 items-center p-6 relative rounded-bl-xxl rounded-br-xxl shrink-0 w-full" data-name="Card">
        {/* Property Info */}
        <div className="flex items-start justify-between relative shrink-0 w-full" data-name="PropertyCard">
          <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
            <div className="bg-clip-padding border-0 border-transparent border-solid box-border flex flex-col gap-1 items-start relative w-full">
              <p className="font-sans font-normal leading-base not-italic relative shrink-0 text-primary text-h5" data-name="Property Title">
                {property.name}
              </p>
              <div className="box-border flex gap-2 items-center px-0 py-px relative shrink-0 w-full" data-name="Address">
        ...
        {/* Stats Section */}
        <div className="flex flex-col gap-2 items-start relative shrink-0 w-full" data-name="Stats Section">
          ...
          <div className="content-center flex flex-wrap gap-2 items-center justify-between relative shrink-0 w-full" data-name="Stats Row 1">
            <div className="flex gap-2 h-4 items-center relative shrink-0 w-33" data-name="Units Container">
            ...
            <div className="flex gap-2 h-4 items-center relative shrink-0 w-33" data-name="Revenue Container">
          ...
          <div className="content-center flex flex-wrap gap-2 items-center justify-between relative shrink-0 w-full" data-name="Stats Row 2">
            <div className="flex gap-2 items-center relative shrink-0 w-33" data-name="Date Container">
            ...
            <div className="flex gap-2 items-center relative shrink-0 w-33" data-name="Manager Container">
